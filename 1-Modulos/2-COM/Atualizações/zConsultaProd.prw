...
@return  	n/t
@obs.......  
o	Especifico cliente 
	CAMPO->C1_PRODUTO
	CONSULTA PADRAO-> B1C1X
Deverá ser criado a consulta padrão e alterada a chamada 
Substitui a tela padrão do Protheus consulta cadastro de produtos.

Filtro inteligente 
xxx......
/*/
//-----------------------------------------------------------------------------------------------------------
User Function zConsultaProd()
	...
	//-----------------------------------------------------------------------------------
	// Função para realizar a pesquisa os itens
	//-----------------------------------------------------------------------------------
	fPesquisa()
