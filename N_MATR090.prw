//#INCLUDE "MATR090.CH"
#INCLUDE "PROTHEUS.CH" 
//Copiado para TDS em 30/03/2017 22:17
/*/
...
Local cTitle   := "Relacao de Compras" //"Relacao de Compras"
...
oReport:= TReport():New("MTR090",cTitle,"MTR090", {|oReport| ReportPrint(oReport,aOrdem,cAliasSD1)},""+" "+"Este relatorio ira imprimir a relacao de itens referentes a compras efetuadas.") //"Este relatorio ira imprimir a relacao de itens referentes a compras efetuadas."
...
//³                                                                        ³
//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
oSection1:= TRSection():New(oReport,"",{"SD1","SF1","SD2","SF2","SB1","SA1","SA2","SF4"},aOrdem)
...
TRCell():New(oSection1,"D1_DOC"    ,"SD1",/*Titulo*/	,/*Picture*/, TamSX3("D1_DOC")[1]+If(TamSX3("D1_COD")[1]>15,0,4),/*lPixel*/,/*{|| code-block de impressao }*/)
...
TRCell():New(oSection1,"B1_DESC"   ,"SB1",/*Titulo*/	,/*Picture*/,22,/*lPixel*/,/*{|| code-block de impressao }*/)
TRCell():New(oSection1,"D1_QUANT"  ,"SD1",/*Titulo*/	,/*Picture*/,/*Tamanho*/,/*lPixel*/,/*{|| code-block de impressao }*/)
TRCell():New(oSection1,"D1_UM"     ,"SD1",""		,/*Picture*/,/*Tamanho*/,/*lPixel*/,/*{|| code-block de impressao }*/)
TRCell():New(oSection1,"VALUNIT"   ,"   ",""		,/*Picture*/,/*Tamanho*/,/*lPixel*/,{|| nValUnit })

If cPaisloc=="BRA"
	If lVeiculo
		TRCell():New(oSection1,"D1_IPI","SD1","",/*Picture*/,/*Tamanho*/,/*lPixel*/,/*{|| code-block de impressao }*/)
	Else
		TRCell():New(oSection1,"D1_IPI","SD1",/*Titulo*/,/*Picture*/,/*Tamanho*/,/*lPixel*/,/*{|| code-block de impressao }*/)
	EndIf
Else
	TRCell():New(oSection1,"IMPNOINC","   ","",cPictImp,/*Tamanho*/,/*lPixel*/,{|| nImpNoInc })
EndIf

TRCell():New(oSection1,"VALTOTAL"  ,"   ","",/*Picture*/,/*Tamanho*/,/*lPixel*/,{|| nValTot  })

If cPaisloc=="BRA"
	If lVeiculo
		TRCell():New(oSection1,"D1_PICM","SD1","",/*Picture*/,/*Tamanho*/,/*lPixel*/,/*{|| code-block de impressao }*/)
	Else
		TRCell():New(oSection1,"D1_PICM","SD1",/*Titulo*/,/*Picture*/,/*Tamanho*/,/*lPixel*/,/*{|| code-block de impressao }*/)
	EndIf
Else
	TRCell():New(oSection1,"IMPINC","   ","",cPictImp,/*Tamanho*/,/*lPixel*/,{|| nImpInc })
EndIf

TRCell():New(oSection1,"D1_FORNECE","SD1",""		,/*Picture*/,/*Tamanho*/,/*lPixel*/,/*{|| code-block de impressao }*/)
TRCell():New(oSection1,"RAZAOSOC"  ,"   ",""		,/*Picture*/,nTamCli	,/*lPixel*/,{|| cRazao })
TRCell():New(oSection1,"D1_TIPO"   ,"SD1",""		,/*Picture*/,/*Tamanho*/,/*lPixel*/,/*{|| code-block de impressao }*/)
TRCell():New(oSection1,"D1_TES"    ,"SD1",""			,/*Picture*/,/*Tamanho*/,/*lPixel*/,/*{|| code-block de impressao }*/)  
TRCell():New(oSection1,"D1_CF"     ,"SD1","CF"			,/*Picture*/,/*Tamanho*/,/*lPixel*/,/*{|| code-block de impressao }*/)
TRCell():New(oSection1,"D1_DESC1"  ,"SD1","Desc."			,/*Picture*/,/*Tamanho*/,/*lPixel*/,/*{|| code-block de impressao }*/)
TRCell():New(oSection1,"D1_CC"     ,"SD1","Centro"			,/*Picture*/,/*Tamanho*/,/*lPixel*/,/*{|| code-block de impressao }*/)
TRCell():New(oSection1,"D1_DESC2"  ,"SD1","Desc"			,/*Picture*/,/*Tamanho*/,/*lPixel*/,/*{|| code-block de impressao }*/)
TRCell():New(oSection1,"D1_TP"     ,"SD1",""		,/*Picture*/,/*Tamanho*/,/*lPixel*/,/*{|| code-block de impressao }*/)
TRCell():New(oSection1,"D1_GRUPO"  ,"SD1",/*Titulo*/	,/*Picture*/,/*Tamanho*/,/*lPixel*/,/*{|| code-block de impressao }*/)
TRCell():New(oSection1,"D1_DTDIGIT","SD1",""		,/*Picture*/,/*Tamanho*/,/*lPixel*/,/*{|| code-block de impressao }*/)
TRCell():New(oSection1,"VALCUSTO"  ,"   ",""		,/*Picture*/,/*Tamanho*/,/*lPixel*/,{|| nValCusto })
TRCell():New(oSection1,"D1_LOCAL"  ,"SD1",""		,/*Picture*/,/*Tamanho*/,/*lPixel*/,/*{|| code-block de impressao }*/)
...
oSection2:= TRSection():New(oSection1,"",{"SD2","SF2","SD1","SF1","SB1","SA1","SA2","SF4"}) 
...
TRCell():New(oSection2,"PRCVEN"    ,"   ",""	 ,/*Picture*/,/*Tamanho*/,/*lPixel*/,{|| nValUnit })

If cPaisloc=="BRA"
	TRCell():New(oSection2,"D2_IPI","SD2",/*Titulo*/,/*Picture*/,/*Tamanho*/,/*lPixel*/,/*{|| code-block de impressao }*/)
Else
	TRCell():New(oSection2,"IMPNOINC","   ","",cPictImp,/*Tamanho*/,/*lPixel*/,{|| nImpNoInc })
EndIf

TRCell():New(oSection2,"VALTOTAL"  ,"   ","",/*Picture*/,/*Tamanho*/,/*lPixel*/,{|| nValTot * -1 })

If cPaisloc=="BRA"
	TRCell():New(oSection2,"D2_PICM","SD2",/*Titulo*/,/*Picture*/,/*Tamanho*/,/*lPixel*/,/*{|| code-block de impressao }*/)
Else
	TRCell():New(oSection2,"IMPINC","   ","",cPictImp,/*Tamanho*/,/*lPixel*/,{|| nImpInc })
EndIf

TRCell():New(oSection2,"D2_CLIENTE","SD2",/*Titulo*/,/*Picture*/,/*Tamanho*/,/*lPixel*/,/*{|| code-block de impressao }*/)
TRCell():New(oSection2,"RAZAOSOC"  ,"   ",""	 ,/*Picture*/,nTamCli	 ,/*lPixel*/,{|| cRazao })
...
TRCell():New(oSection2,"D2_CF"     ,"SD2",/*Titulo*/,/*Picture*/,/*Tamanho*/,/*lPixel*/,/*{|| code-block de impressao }*/) 
TRCell():New(oSection2,"D2_DESC1"  ,"SD2",/*Titulo*/,/*Picture*/,/*Tamanho*/,/*lPixel*/,/*{|| code-block de impressao }*/) 
TRCell():New(oSection2,"D2_CUSTO1"  ,"SD2",/*Titulo*/,/*Picture*/,/*Tamanho*/,/*lPixel*/,/*{|| code-block de impressao }*/) 
TRCell():New(oSection2,"D2_DESC2"  ,"SD2",/*Titulo*/,/*Picture*/,/*Tamanho*/,/*lPixel*/,/*{|| code-block de impressao }*/) 
...
TRCell():New(oSection2,"VALCUSTO"  ,"   ",""	 ,/*Picture*/,/*Tamanho*/,/*lPixel*/,{|| nValCusto * -1 })
...
oSection2:Cell("D2_DESC1"	):GetFieldInfo("D1_CC"		)
oSection2:Cell("D2_CUSTO1"	):GetFieldInfo("D2_CUSTO1"	)
oSection2:Cell("D2_DESC2"	):GetFieldInfo("D1_CC"		)
...
oSection2:Cell("D2_DESC1"	):HideHeader()
oSection2:Cell("D2_CUSTO1"	):HideHeader()
oSection2:Cell("D2_DESC2"	):HideHeader()
...
#IFDEF TOP
	...
	cSelect1 += "D1_TOTAL,  D1_TES,D1_CF,D1_CC, D1_IPI,   D1_PICM,    D1_TIPO, D1_TP,      D1_GRUPO, D1_CUSTO, D1_LOCAL, D1_QTDEDEV, D1_ITEM, D1_UM," 
	...
	SELECT D1_FILIAL,D1_DOC,     D1_SERIE,   D1_FORNECE, D1_LOJA, D1_DTDIGIT,    D1_COD,   D1_QUANT, D1_VUNIT,
		   D1_TOTAL, D1_TES,D1_CF,D1_CC,D1_IPI,     D1_PICM,    D1_TIPO, D1_TP,         D1_GRUPO, D1_CUSTO, D1_LOCAL, D1_QTDEDEV, D1_ITEM,D1_UM,
...
If mv_par07 == 1
	...
	dbSelectArea("SD2")
	IndRegua("SD2",cArqTrbSD2,"D2_FILIAL+D2_COD+D2_NFORI+D2_ITEMORI+D2_SERIORI+D2_CLIENTE+D2_LOJA",,cCondSD2,"Selecionando Registros...")		//"Selecionando Registros..."
...
If nOrdem == 1
	...
	//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ	
	oBreak1 := TRBreak():New(oSection1,oSection1:Cell("D1_DOC")    ,"TOTAL NOTA FISCAL --> ",.F.,"NFE") // "TOTAL NOTA FISCAL --> "
	oBreak2 := TRBreak():New(oSection1,oSection1:Cell("D1_FORNECE"),"TOTAL FORNECEDOR  --> ",.F.) // "TOTAL FORNECEDOR  --> "
...
ElseIf nOrdem == 2
	...
	oBreak1 := TRBreak():New(oSection1,oSection1:Cell("D1_DOC")    ,"TOTAL NOTA FISCAL --> ",.F.,"NFE") // "TOTAL NOTA FISCAL --> "
	oBreak2 := TRBreak():New(oSection1,oSection1:Cell("D1_FORNECE"),"TOTAL FORNECEDOR  --> ",.F.) // "TOTAL FORNECEDOR  --> "
	oBreak3 := TRBreak():New(oSection1,oSection1:Cell("D1_DTDIGIT"),"TOT. NA DATA ",.F.) // "TOT. NA DATA "
...
ElseIf nOrdem == 3
	...
	//³ Definicao das quebras e totalizadores que serao Impressos.   ³
	//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ	
	oBreak1 := TRBreak():New(oSection1,oSection1:Cell("COD"),"TOTAL PRODUTO     --> ",.F.,"PROD") // "TOTAL PRODUTO     --> "
	oBreak2 := TRBreak():New(oSection1,oSection1:Cell("D1_GRUPO")  ,"TOTAL GRUPO ",.F.) // "TOTAL GRUPO "
	oBreak3 := TRBreak():New(oSection1,oSection1:Cell("D1_TP")     ,"TOTAL TIPO  ",.F.) // "TOTAL TIPO  "
...
For nX :=1 to Len(aRecno)
	...
	While !Eof() .And. SD1->D1_FILIAL+SD1->D1_COD+SD1->D1_DOC+SD1->D1_ITEM+SD1->D1_SERIE+SD1->D1_FORNECE+SD1->D1_LOJA ==;
		...
		If nX == 1
			oReport:PrintText('-Devolucoes:',,oSection2:Cell("D2_DOC"):ColPos()) //'-Devolucoes:'
		Endif
...
Private cCABPROD  := "TOTAL PRODUTO     --> " //"TOTAL PRODUTO     --> "
PRIVATE titulo  := OemToAnsi("Relacao de Compras")	//"Relacao de Compras"
PRIVATE cDesc1  := OemToAnsi("Este relatorio ira imprimir a relacao de itens")	//"Este relatorio ira imprimir a relacao de itens"
PRIVATE cDesc2  := OemToAnsi("referentes a compras efetuadas.")	//"referentes a compras efetuadas."
PRIVATE cDesc3  := ""
PRIVATE cPerg   := "MTR090"
PRIVATE tamanho := "G"
PRIVATE aOrd    := {OemToAnsi(" Fornecedor         "),OemToAnsi(" Data De Digitacao  "),OemToAnsi(" Tipo+Grupo+Codigo  ") ,OemToAnsi("")}//" Fornecedor         "###" Data De Digitacao  "###" Tipo+Grupo+Codigo  "###" Grupo+Codigo   "
PRIVATE aReturn := {OemToAnsi(""),1,OemToAnsi(""), 1, 2, 1, "",1}		//"Zebrado"###"Administracao"
PRIVATE aLinha  := { }
...
If cPaisLoc == "BRA"
	If aTamSXG[1] <> aTamSXG[3]
		cabec1:= ""  //"NOTA         PRODUTO         DESCRICAO                            QUANTIDADE UM      PR.UNITARIO  IPI             VALOR  ICM  CODIGO               RAZAO SOCIAL               TP TES TIPO GRUPO DATA DIG.           CUSTO LO"
	...
	Else
		cabec1:= ""  //"NOTA         PRODUTO         DESCRICAO                            QUANTIDADE UM      PR.UNITARIO  IPI             VALOR  ICM  CODIGO RAZAO SOCIAL                             TP TES TP  GRUPO  DATA DIG.           CUSTO LO"
...
If mv_par07 == 1
	...
	dbSelectArea("SD2")
	IndRegua("SD2",cNomeArq1,"D2_COD+D2_NFORI+D2_ITEMORI+D2_SERIORI+D2_CLIENTE+D2_LOJA",,cCondSD2,"Selecionando Registros...")		//"Selecionando Registros..."
...
#ENDIF        
      ...
      Endif
		...
		EndIf
      IndRegua("SD1",cNomeArq,cIndice,,Condicao,"Selecionando Registros...")		//"Selecionando Registros..."
		...
		For i:=1 to Len(aRec)
			...
			While !Eof() .And. SD1->D1_COD+SD1->D1_DOC+SD1->D1_ITEM+SD1->D1_SERIE+SD1->D1_FORNECE+SD1->D1_LOJA ==;
				...
				if !empty(SD2->D2_TES) .and. MsSeek(xSF4 + SD2->D2_TES)
					...
					dbSelectArea("SD2")
					If i == 1
						@ li++,000 PSAY '-Devolucoes:'		//'-Devolucoes:'
					Endif
...
If li <> 80
	If nTotal <> 0
		...
		@ li,000 PSAY "TOTAL GERAL       --> "		//"TOTAL GERAL       --> "
...
Endif
IF ! lVEIC
	@ li,000 PSAY "TOTAL PRODUTO     --> "		//"TOTAL PRODUTO     --> "
ELSE
   SB1->(DBSETORDER(1))
...
If li > 59
	cabec(titulo+" ("+alltrim(aOrd[nOrdem])+")",cabec1,cabec2,nomeprog,tamanho,15)
Endif
@ li,000 PSAY "TOTAL GRUPO "+cGrupo+"  --> "		//"TOTAL GRUPO "
...
If li > 59
	cabec(titulo+" ("+alltrim(aOrd[nOrdem])+")",cabec1,cabec2,nomeprog,tamanho,15)
Endif
@ li,000 PSAY "TOTAL TIPO  "+cTipo+"    --> "		//"TOTAL TIPO  "
...
If nTotVal <> 0 .Or. nTotProd <> 0
	@ li,000 PSAY "TOTAL NOTA FISCAL --> "		//"TOTAL NOTA FISCAL --> "
	@ li,060+nIncCol	 PSAY nTotQt 		Picture PesqPict("SD1","D1_QUANT",16)
	If cPaisLoc == "BRA"
		@ li,103 	 	 PSAY nTotVal		Picture PesqPict("SD1","D1_TOTAL",16,mv_par09)
	Else
...
If nTotVal1 <> 0 .Or. nTotProd <> 0
	@ li,000 PSAY "TOTAL FORNECEDOR  --> "		//"TOTAL FORNECEDOR  --> "
	@ li,060+nIncCol	 PSAY nTotQt1  	Picture PesqPict("SD1","D1_QUANT",16)
	If cPaisLoc == "BRA"
		@ li,103		 PSAY nTotVal1 	Picture PesqPict("SD1","D1_TOTAL",16,mv_par09)
	Else
...
If nTotVal <> 0 .Or. nTotCus <> 0
	@ li,000 PSAY "TOT.DA DATA "+DTOC(cQuebraDtDig) //"TOT.DA DATA "
	@ li,060+nIncCol	 PSAY nTotQt		Picture PesqPict("SD1","D1_QUANT",16)
	If cPaisLoc == "BRA"
		@ li,103 		 PSAY nTotVal		Picture PesqPict("SD1","D1_TOTAL",16,mv_par09)
	Else
