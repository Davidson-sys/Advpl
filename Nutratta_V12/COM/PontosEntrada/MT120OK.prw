...
|Nome              | MT120OK                                                 |
+------------------+---------------------------------------------------------+
|Descricao         | Ponto de entrada para validação das informações digita- |
...
|Parametros        | Nenhum                                                  |
+------------------+---------------------------------------------------------+
|Retorno           | .T. = Libera a inclusão/alteração                       |
|                  | .F. = Bloqueia a inclusão/alteração                     |
+------------------+---------------------------------------------------------+
...
User Function MT120OK()
        ...
        //If Type("cOrigem") = "C" .And. cOrigem == "CNTA120"
                ...
                //+----------------------------------------------------------+
                //|                  VALIDAÇÕES NO PEDIDO                    |
                //+----------------------------------------------------------+
                //+----------------------------------------------------------+
                //| Valida se tem rateio, não é obrigatorio o Centro de Custo|
                //+----------------------------------------------------------+
                For nX := 1 To Len(aCols)
                        ...
                        If Empty(aCols[nX][nPosCC])
                                ...
                                If aCols[nX][nPosRateio] == "2"
                                        ...
                                        cMsgErro += __ENTER +"- O centro de custo só pode ficar em branco quando tem rateio."+__ENTER+;
						...
						//-----------------------------------------------------------------------------------
						// Validação local de estoque no pedido de compras, de acordo com cadastro de produtos.
						//-----------------------------------------------------------------------------------
                        ...
                        If cLocPed <> cLocalEst
                              cMsgErro += __ENTER +"-O Local de estoque não é o padrão do produto."+__ENTER+;
