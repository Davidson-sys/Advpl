...
¦+----------+------------------------------------------------------------------¦¦
¦¦Descrição ¦Forma de Pagamento no Pedido de Compras e Doc. Entrada	    	   ¦¦
¦¦          ¦                                                                  ¦¦
¦+----------+------------------------------------------------------------------¦¦
...
Private aLista			:= {}
	...
	While lSeleciona // Verifica se ao menos um item foi selecionado!
		...
		oListBox	:= TWBrowse():New(001,003,300,150,,{" ","Código","Descrição"},,oDlgSXB,,,,,,,/*oFont*/,,,,,.F.,,.T.,,.F.,,,)
...
//¦+-------------------------------------------------------------+¦
//¦¦Força ao Usuário Marcar somente uma opção!			         ¦¦
//¦+-------------------------------------------------------------+¦
