...
Data------: 13/05/2019 -Utilizado na revitalização de comissão 2019.
========================================================================================================================
...
//--------------------------------------------------------------------------------
//Posiciona na DA1 para buscar o percentual de comissão a ser aplicado.
//--------------------------------------------------------------------------------
...
If dbSeek(xFilial(Padr(_cAlias,3))+Padr(_cTAbZZs,3)+Padr(_cCodTab,3)+Padr(_cCond,3)+Alltrim(Padr(_cProduto,15)))
	...
	*/
	...
	///-----------------------------------------------------------------------------------------
	// Pega o menor preço da tabela de preço.
	//------------------------------------------------------------------------------------------
	...
	For i:=1 To Len(_aTitulo)
		...
		If  _aTitulo[i][2] > 0
			...
			_nPrcMax 	:= _aTitulo[i][2]  //Retorna o preço maximo.
	...
	_nValComiss:= (_nBaseComiss * _nPercent)/100   //Retonar o valor de comissão
EndIf
...
ElseIf _nOpc == 4	//Retorna o menorpreço encontrado na tabela de preço.
	_nRetorno:= _nPrcTbl	
ElseIf _nOpc == 5 	//Retorna o maior preço encontrado na tabela de preço.
	_nRetorno:= _nPrcMax	
...
Data------: 25/01/2019
========================================================================================================================
Descrição-: Rotina para buscar selecionar o tipo de vendedor.
...
ElseIf Dtos(_dEmissao) >= '20181203' .And. Dtos(_dEmissao) <= '20190207'
	//------------------------------------------------------------------------------------------------------
	//Rotina para calcular a comissão de cada produto do pedido de vendas.-ZA7- Outubro 2018. 
	// Usado: 5-7 - ZA7
	//------------------------------------------------------------------------------------------------------		
	_cTAbZZs:="ZA7"
	_cTipVend:='7'																	
...
ElseIf Dtos(_dEmissao) >= '20190208' .And. Dtos(_dEmissao) <= '20190315'
	//------------------------------------------------------------------------------------------------------
	//Rotina para calcular a comissão de cada produto do pedido de vendas.-ZA8- Outubro 2018. 
	// Usado: 5-7 - ZA8
	//------------------------------------------------------------------------------------------------------		
	_cTAbZZs:="ZA9"
	_cTipVend:='7'
...
ElseIf Dtos(_dEmissao) >= '20190808'  .And. Dtos(_dEmissao) <= '20191008'
	//------------------------------------------------------------------------------------------------------
	//Rotina para calcular a comissão de cada produto do pedido de vendas.-ZB7 
	// Usado: 5-7 - ZA8
	//------------------------------------------------------------------------------------------------------		
	_cTAbZZs:="ZB6"
	_cTipVend:='7'	
...
ElseIf Dtos(_dEmissao) >= '20191118'    .And. Dtos(_dEmissao) <= '20200420'   //Comissinamento negativo
	//------------------------------------------------------------------------------------------------------
	//Rotina para calcular a comissão de cada produto do pedido de vendas.-ZB8. 
	// Usado: 5-7 - ZB7
	//------------------------------------------------------------------------------------------------------		
	_cTAbZZs:="ZB8"
	_cTipVend:='7'	
...
ElseIf  Dtos(_dEmissao) >= '20200421'  .And. Dtos(_dEmissao) <= '20200531'
	//------------------------------------------------------------------------------------------------------
	//Rotina para calcular a comissão de cada produto do pedido de vendas.-ZB9. 
	// Usado: 5-7 - ZB9
	//------------------------------------------------------------------------------------------------------		
	_cTAbZZs:="ZB9"
	_cTipVend:='7'
...
Data------: 14/05/2019
========================================================================================================================
Descrição-: Função para buscar a condição de pagamento e realizar tratamento das datas de pagamento e quantidade de 
Uso-------: Parcela.
========================================================================================================================
*/
...
//------------------------------------------------------------------
// Retorno com as informações referentes a condição de pagamento.  
//------------------------------------------------------------------
If _nOpc == 1
	_cReturn:= _cCondRel	
ElseIf _nOpc == 2
