...
Relatorio de pedidos onde serแ impresso os locais de estoque informados.
...
param   	n/t
return  	n/t
Especifico Nutratta Nutri็ใo Animal.
19/09/2019-Valida็ใo de impressใo:Relatorio s๓ serแ gerado para pedidos onde a TES 
...
#IFNDEF TOP
		MsgAlert(STR0059,STR0004)	 //"Relat๓rio somente para Bancos Relacionais (TOP)."###"Aten็ใo"
		Return
#ENDIF
...
//Monta arquivo de trabalho temporแrio
MsAguarde({||MontaQuery()},STR0001,STR0002) //'Aguarde'###'Criando arquivos para impressใo...'
...
DbGoTop()
If (_cAlias)->(Eof())
	MsgAlert(STR0003,STR0004) //"Relat๓rio vazio! Verifique os parโmetros."###"Aten็ใo"
Else
...
ฑฑบPrograma  ณMATR730A  บAutor  ณMicrosiga           บ Data ณ  08/21/13   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ  MONTA A PAGINA DE IMPRESSAO                               บฑฑ
ฑฑบ          ณ                                                            บฑฑ
...
//Fontes a serem utilizadas no relat๓rio
...
If oPrn:Setup() == .F.    			// Configura็ใo da impressora 
	oPrn:End()
	Return
EndIf	
...
While (_cAlias)->(!Eof()) 
	...
	//Caso a TES nใo atualize estoque o relatorio nใo serแ gerado.
	_lContinua:= fValdTES((_cAlias)->C6_TES)
	
	If !_lContinua 
	                           
		MsgAlert("A TES informada no Pedido, nใo atualiza estoque. ","TES INVมLIDA!!!  "+"Pedido/TES:"+(_cAlias)->C5_NUM+"/"+(_cAlias)->C6_TES) 
		Exit
	EndIf
...
//Informa็๕es adicionais.
nLin += 050
oPrn:say (nLin,nCol1,"Inf.Adicionais:", oFont10N) //"Msg Informa็ใo adicional: "
...
// Subtitulo do Corpo
oPrn:say (nLin,0300,STR0067,oFont10N)		//"C๓digo"
oPrn:say (nLin,0800,STR0068,oFont10N)  		//"Descri็ใo"
oPrn:say (nLin,1600,STR0069,oFont10N)		//"Unid."
oPrn:say (nLin,1500,STR0066,oFont10N) 		//"Qtde"
oPrn:say (5,2370,Transform(_nPag,"@R 999"),oFont10N)    //Impressใo do numero da pแgina
...
*********************************************
** VARIมVEIS INICIALIZADAS COMO CONTADORES **
*********************************************
//Private nLin	 := 100
...
****************************************
** VARIมVEIS DO CONTEฺDO DO RELATำRIO **
****************************************
Private cTitulo := "LOCAL DE ENTREGA"
Private oRel

//-----------------------------------------------------------------------------------
// Fim das declara็๕es de variaveis.
//-----------------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------------
// Impressใo Grafica: Locais de entrega Nutratta
//-----------------------------------------------------------------------------------
************************************
** MONTA A RษGUA DE PROCESSAMENTO **
************************************
...
**************************************
** FUNวรO DE IMPRESSรO DO RELATำRIO **
**************************************
...
ProcRegua(8)
IncProc("Preparando a impressใo...")
cDirSpool := ""
//dbSelectArea("SCJ")
...
//------------------------------------------------------------------------------------------
//Posiciona na tabela SC5 para pegar as informa็๕es do local de entrega vinculado ao pedido 
//-----------------------------------------------------------------------------------------
dbSelectArea("SC5")
dbSetOrder(1)
...
//-----------------------------------------------------------------------------------
// Impressใo grafica do realtorio de local de entrega 
//-----------------------------------------------------------------------------------
//nLin := 1000	
//nLin += 100                      
...
oPrn:Say(nLin+130,nCol+800,"Endere็o:" ,oFont10N,,CLR_GRAY)
...
oPrn:Say(nLin+60,35,"INFORMAวรO CHAPA:" ,oFont10N,,CLR_BLACK)
...
// Abertura das tabela, para garantir a criacao caso alguma nใo exista ainda
dbSelectArea("SC5")
dbSelectArea("SC6")
dbSelectArea("SE4")
dbSelectArea("SB1")
...
AADD(aRegs,{cPerg,"03",STR0049,"","","mv_ch3","C",06,0,0,"G","","mv_par03","","","","","","","","","","","","","","","","","","","","","","","","","SA1"}) //"At้ o Cliente   	  ?"
AADD(aRegs,{cPerg,"04",STR0074,"","","mv_ch4","C",02,0,0,"G","","mv_par04","","","","","","","","","","","","","","","","","","","","","","","","",""}) //"At้ a Loja   	  ?"
AADD(aRegs,{cPerg,"05",STR0050,"","","mv_ch5","C",06,0,0,"G","","mv_par05","","","","","","","","","","","","","","","","","","","","","","","","","SC5"}) //"Do Pedido       	  ?"
AADD(aRegs,{cPerg,"06",STR0051,"","","mv_ch6","C",06,0,0,"G","","mv_par06","","","","","","","","","","","","","","","","","","","","","","","","","SC5"}) //"At้ o Pedido    	  ?"
AADD(aRegs,{cPerg,"07",STR0052,"","","mv_ch7","D",08,0,0,"G","","mv_par07","","","","","","","","","","","","","","","","","","","","","","","","",""}) //"Da Emissใo        	  ?"
AADD(aRegs,{cPerg,"08",STR0053,"","","mv_ch8","D",08,0,0,"G","","mv_par08","","","","","","","","","","","","","","","","","","","","","","","","",""}) //"At้ Emissใo       	  ?"
AADD(aRegs,{cPerg,"09",STR0054,"","","mv_ch9","C",06,0,0,"G","","mv_par09","","","","","","","","","","","","","","","","","","","","","","","","","SA3"}) //"Do Vendedor      	  ?"
AADD(aRegs,{cPerg,"10",STR0055,"","","mv_ch10","C",06,0,0,"G","","mv_par010","","","","","","","","","","","","","","","","","","","","","","","","","SA3"}) //"At้ o Vendedor   	  ?"
...
While !((cAliasSC5)->(Eof())) .and. xFilial("SC5")==(cAliasSC5)->C5_FILIAL
	...
	//ณ Executa a validacao dos filtros do usuario           	     ณ
	...
	While !((cAliasSC6)->(Eof())) .And. xFilial("SC6")==(cAliasSC6)->C6_FILIAL .And.;
		...
		//ณForca os valores de impostos que foram informados no SC6.              ณ
...
Valida็ใo para permitir que seja gerado o relatorio em TES sem 
atualiza็ใo de estoque .
de contribui็ใo.
@Author   Davidson-Nutratta
@Since 	   17/09/2019.
@Version 	P11 R5
...
@return  	n/t
@obs.......  
o	Especifico Nutratta Nutri็ใo Animal.
