...
30/04/2020- Criar um campo no relatório para trazer o conteduo C5_C_INFAD
/*/
...
TRCell():New(oSection1,"CDESCR"		,"","Descrição"		 ,"@!"	  					,60,/*lPixel*/	,{|| cDescrição })
TRCell():New(oSection1,"CCOND"		,"","Cond.pgto"		 ,"@!"	  					,03,/*lPixel*/	,{|| cCondicao })
TRCell():New(oSection1,"CDESCOND"	,"","Descrição"		 ,"@!"	  					,15,/*lPixel*/	,{|| cDescrição})
...
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄ´±±
±±³Descri‡…o ³Gravação da tabela temporaria                                 ³±±
